...
![docker registry sequence diagram](../build/images/posts/../../../public/images/posts/docker-registry-mermaid.png)
<span style="font-size: 0.6em">I did not configure mermaid in my blog yet. I will replace the image with the diagram when it is ready</span>
